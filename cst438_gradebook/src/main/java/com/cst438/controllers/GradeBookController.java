...
public class GradeBookController {
	...
	@Transactional
	public ResponseEntity<Assignment> getAssignmentById(@PathVariable int assignment_id) {
	  Optional<Assignment> optionalAssignment = assignmentRepository.findById(assignment_id);
